      ...
      <div class="container mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <!-- <nav class="flex items-center gap-6">
          <a 
            ...
            target="_blank"
            class="text-text-secondary hover:text-primary-pink transition-colors flex items-center gap-2"
          >
          ...
          <a 
            href="#about" 
            class="text-text-secondary hover:text-primary-pink transition-colors"
          >
            关于我
          </a>
          <a 
