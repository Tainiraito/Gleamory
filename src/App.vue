...
import type { ProjectsData, UpdatesData, Project, Update } from './types'
...
const updates: Update[] = [...(updatesData as UpdatesData).updates].reverse()

const githubUrl = 'https://github.com/Tainiraito/Gleamory'
